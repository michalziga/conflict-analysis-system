...
![CI](https://github.com/michalziga/conflict-analysis-system/actions/workflows/ci.yml/badge.svg)
...
```bash
# 1. Clone
git clone https://github.com/michalziga/conflict-analysis-system
